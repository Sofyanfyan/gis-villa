            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="/kecamatan/add" type="button" class="btn btn-tool " ><i class= "fa fa-plus"></i> Tambahkan </a>
                            ...
                            @foreach($kecamatan as $data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                      <a href="/kecamatan/edit/{{ $data->id_kecamatan }}" type="button" class="btn btn-block btn-warning btn-sm" width="12px">Edit</a>
                                      <button data-toggle="modal" data-target="#delete{{ $data->id_kecamatan }}" type="button" class="btn btn-block btn-danger btn-sm" width="12px">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
