                ...
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>E-Mail</label>
                          <input name="email" class="form-control" value="{{  old('email')   }}" placeholder="E-Mail User">
                          <div class="text-danger">
                              @error('email')
                                {{$message}}
                              @enderror
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input name="password" class="form-control"  value="{{  old('password')   }}"  placeholder="Password User">
                          <div class="text-danger">
                              @error('password')
                                {{$message}}
                              @enderror
