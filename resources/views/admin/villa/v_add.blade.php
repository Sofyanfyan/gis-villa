...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="card-header">
            <h3 class="card-title">Tambah Data Villa</h3>
        </div>
        <form action="/villa/insert" method="post" enctype="multipart/form-data">
            @csrf
        <div class="card-body">   
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input name="nama_villa" class="form-control" placeholder="Nama Villa">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <select name="id_harga" class="form-control" >
                              <option value="">-- Pilih List Harga --</option>
                      ...
                      <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          ...
                          <input name="harga_villa" class="form-control" placeholder="Harga">
                          <div class="text-danger">
                              @error('harga_villa')
                                {{$message}}
                              @enderror
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <select name="kolam" class="form-control" >
                              <option value="">-- Pilih Ketersediaan Kolam --</option>
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="form-group">
                          ...
                          <input name="alamat" class="form-control" placeholder="Alamat Villa">
                          <div class="text-danger">
                              @error('alamat')
                                {{$message}}
                              @enderror
                      ...
                      <div class="col-sm-4">
                        ...
                        <div class="form-group">
                          ...
                          <input name="posisi" id="posisi" class="form-control" placeholder="Posisi Villa">
                          <div class="text-danger">
                              @error('posisi')
                                {{$message}}
                              @enderror
                ...
                <div class="form-group">
                  <label>Nomer Telepon</label>
                   <input name="Telepon" id="posisi" class="form-control" placeholder="Nomer Telepon">
                   <div class="text-danger">
                       @error('Telepon')
                        {{$message}}
                      @enderror
...
var peta1 = L.tileLayer(
        ...
        var curLocation = [-7.882791998768492, 112.53318294269594];
